...
using Antigravity.Editor.Messaging;
using Antigravity.Editor.Testing;
using UnityEditor;
using UnityEngine;
using MessageType = Antigravity.Editor.Messaging.MessageType;
...
namespace Antigravity.Editor
{
	...
	internal class VisualStudioIntegration
	{
		...
		{
			if (!AntigravityExternalEditor.IsEnabled)
				return;
