...
namespace Antigravity.Editor
{
	...
	public class ProjectGeneration : IGenerator
	{
		...
		IAntigravityBaseInstallation m_CurrentInstallation;
		...
		private void CreateExtraFiles(IAntigravityBaseInstallation installation)
		{
		...
		{
			var editor = CodeEditor.CurrentEditor as AntigravityExternalEditor;
			editor?.TryGetAntigravityBaseInstallationForPath(CodeEditor.CurrentEditorInstallation, lookupDiscoveredInstallations: true, out m_CurrentInstallation);
		}
