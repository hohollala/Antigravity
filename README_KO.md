# Antigravity IDE Editor for Unity - 한국어 가이드

이 문서는 한국어 사용자를 위한 종합 가이드입니다.

## 설치 (3분)

### 1단계: Antigravity IDE 설치

Antigravity 공식 다운로드 페이지에서 **Antigravity IDE**를 설치하세요: https://antigravity.google/download
...
3. External Script Editor에서 Antigravity IDE 선택
...
C# 스크립트 파일을 더블클릭하면 Antigravity IDE가 자동으로 실행됩니다.

## 문제 해결

| 문제 | 해결책 |
|------|-------|
| Antigravity IDE가 드롭다운에 안 보여요 | Unity를 완전히 재시작하세요 |
...
**Happy Coding with Antigravity IDE!**
