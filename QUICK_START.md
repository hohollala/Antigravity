# Antigravity IDE Editor for Unity - 빠른 시작 (5분)

5분 안에 Antigravity IDE를 Unity의 기본 코드 에디터로 설정하세요.

## 1️⃣ Antigravity IDE 설치 (2분)
...
C# 스크립트 파일을 **더블클릭**하면 Antigravity IDE에서 자동으로 열립니다.

---

## 문제 발생?

- ❌ Antigravity IDE가 드롭다운에 안 보임?
  → Unity 재시작
